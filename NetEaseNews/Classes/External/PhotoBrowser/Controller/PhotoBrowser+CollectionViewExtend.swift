...
extension PhotoBrowser: UICollectionViewDataSource,UICollectionViewDelegate{
    ...
    override internal func viewDidAppear(animated: Bool) {
        ...
        let isZoomType = self.showType == ShowType.ZoomAndDismissWithCancelBtnClick || self.showType == ShowType.ZoomAndDismissWithSingleTap
    ...
    func collectionViewPrepare(){
        ...
        collectionView.snp_makeConstraints { (make) -> Void in
            ...
            make.edges.equalTo(self.view).inset(UIEdgeInsetsMake(0, 0, 0, -CFPBExtraWidth))
        }
    ...
    internal func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        itemCell.shadowView = self.view
        
        weak var weakSelf = self
        
        itemCell.dismiss = {  weakSelf!.dismissPrepare() }
    ...
    internal func collectionView(collectionView: UICollectionView, didEndDisplayingCell cell: UICollectionViewCell, forItemAtIndexPath indexPath: NSIndexPath) {
